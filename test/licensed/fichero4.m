## "Copyright (C) {{YYYY}} W3C(R) {{Company}}. 
## This software or document includes material copied 
## from or derived from {{title and URI of the W3C 
## document}}." 
##
## Disclaimers
##
## THIS DOCUMENT IS PROVIDED "AS IS," AND COPYRIGHT 
...
## OUT OF ANY USE OF THE DOCUMENT OR THE PERFORMANCE 
